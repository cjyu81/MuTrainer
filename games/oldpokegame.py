...
class PokemonGame:
    ...
    Game will be an account. Initialize to place account in battle
    """
    ...
    def __init__(self, seed=None):
        self.account = SnivyPlayer(battle_format="gen8randombattle")
        self.currentbattle = 1
        self.visible = numpy.zeros((5), dtype="int32")
        self.player = 1
        #await snivy_player.battle_against(max_damage_player, n_battles=1)
        await self.account.send_challenges

    async def botmessage(self, playername, message):
        snivy_player = SnivyPlayer(battle_format="gen8randombattle")
        await snivy_player.snivy_message("Archlei","Hello world. I am Snivy talking from muzero")
